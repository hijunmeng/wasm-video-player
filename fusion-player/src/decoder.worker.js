...
Decoder.prototype.openDecoder = function (req) {
    ...
    ret = this._initDecoder(expectPixfmt);
...
//初始化解码器
Decoder.prototype._initDecoder = function (expectPixfmt) {
    var ret = Module._initDecoder(this.handle, this.videoCallback,expectPixfmt);
